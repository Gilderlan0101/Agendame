...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (dropdownToggle && dropdownMenu) {
        // Fechar dropdown ao tocar fora (mobile)
        document.addEventListener('click', function(e) {
            if (!e.target.closest('.dropdown') && dropdownMenu.classList.contains('show')) {
                dropdownMenu.classList.remove('show');
            }
        });

        // Prevenir fechamento ao tocar dentro do dropdown
        ...
        dropdownMenu.addEventListener('touchmove', function(e) {
            ...
            // Se o usuário deslizar para baixo significativamente
            if (diff > 50) {
                dropdownMenu.classList.remove('show');
            }
        });
